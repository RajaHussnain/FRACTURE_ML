...
#SBATCH -J univariableCox_int_all
#SBATCH -p core
#SBATCH -n 1
#SBATCH --mem=7G
#SBATCH --array=0-15
#SBATCH -t 48:00:00
#SBATCH --output=Logs/Univariable/univariableCox_int_all.log
#SBATCH --error=Logs/Univariable/univariableCox_int_all.err
...
SCRIPT=Prog/Scripts/univariablecox_interaction.py
