...
#SBATCH -J DeepSurv_35_dev
#SBATCH -p node
#SBATCH -t 48:00:00
#SBATCH --output=Logs/DeepSurv/DeepSurv_35_dev.log
#SBATCH --error=Logs/DeepSurv/DeepSurv_35_dev.err
...
OUTPUT_DIR="/path/to/project/Output/DeepSurv/35f"
MODEL_NAME="35_new"
