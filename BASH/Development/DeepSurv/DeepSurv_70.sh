...
#SBATCH -J DeepSurv_70_dev
#SBATCH -p node
#SBATCH -t 48:00:00
#SBATCH --output=Logs/DeepSurv/DeepSurv_70_dev.log
#SBATCH --error=Logs/DeepSurv/DeepSurv_70_dev.err
...
OUTPUT_DIR="/path/to/project/Output/DeepSurv/70f"
MODEL_NAME="70_new"
