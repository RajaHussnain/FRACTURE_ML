...
def main(output_dir):
    file_column_mapping = pd.read_csv('/path/to/project/Data/XGBoost/best_unique_35f.csv', delimiter=';')
    ...
    output_file_path = os.path.join(output_dir, 'best_unique_35.parquet')
