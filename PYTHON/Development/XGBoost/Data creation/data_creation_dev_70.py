...
def main(output_dir):
    file_column_mapping = pd.read_csv('/path/to/project/Data/XGBoost/XGboost_70_final.csv', sep=",")
    ...
    folder = [
        '/path/to/project/Data/XGBoost/A_dev_500.parquet'
    ]
    ...
    output_file_path = os.path.join(output_dir, 'A_dev_70.parquet')
